...
import dev.vishesh.vaadiyancore.config.JwtService;
...
import dev.vishesh.vaadiyancore.model.Role;
import dev.vishesh.vaadiyancore.model.Token;
import dev.vishesh.vaadiyancore.model.TokenType;
 ...
 * This class is used to handle the authentication related requests.
 */
@Service
...
public class AuthenticationService {
    ...
    public AuthenticationResponse authenticate(AuthenticationRequest request) {
        ...
        var user = userRepository.findByUsername(request.getUsername())
                .orElseThrow(() -> new CustomException("User not found with given username", "USER_NOT_FOUND", 403));
        var jwtToken = jwtService.generateToken(user);
        var refreshToken = jwtService.generateRefreshToken(user);
    ...
    public void refreshToken(
        ...
        if (username != null) {
            var user = this.userRepository.findByUsername(username)
                    .orElseThrow(() -> new CustomException("User not found", "USER_NOT_FOUND", 403));
